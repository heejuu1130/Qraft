...
export const gtag = {
  ...
  communityView: (params?: Record<string, unknown>) => send("community_view", params),
  communityReflectionCreate: (params?: Record<string, unknown>) => send("community_reflection_create", params),
  personalNoteCreate: (params?: Record<string, unknown>) => send("personal_note_create", params),
  personalNoteDelete: (params?: Record<string, unknown>) => send("personal_note_delete", params),
  personalNoteGroupDelete: (params?: Record<string, unknown>) => send("personal_note_group_delete", params),
  personalNoteShareToCommunity: (params?: Record<string, unknown>) =>
    send("personal_note_share_to_community", params),
  personalNoteShareFailure: (params?: Record<string, unknown>) => send("personal_note_share_failure", params),
  serviceHelpOpen: (params?: Record<string, unknown>) => send("service_help_open", params),
  serviceHelpClose: (params?: Record<string, unknown>) => send("service_help_close", params),
